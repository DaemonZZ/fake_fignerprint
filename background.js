...
function generate(obj) {
	...
	obj.font_offset = "[" + radomArray(4,8,2).toString() + "]";
	...
	obj.webgl_35661 = "[" + radomArray(512,3,0).toString() + "]";
...
function radomArray(max,size,fix) {
	return [...Array(size)].map(() => Math.floor(Math.random() * max) - fix);
}
